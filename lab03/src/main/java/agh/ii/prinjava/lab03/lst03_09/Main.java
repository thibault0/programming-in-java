...
class ShalowCloner implements Cloneable {
    ...
    public void setIntAtIdx(int idx, int val) { ints[idx] = val; }
    ...
    @Override
    public String toString() { return "ShalowCloner{" + "x=" + x + ", ints=" + Arrays.toString(ints) + '}'; }
}
...
class DeepCloner implements Cloneable {
    ...
    @Override
    public String toString() { return "DeepCloner{" + "x=" + x + ", ints=" + Arrays.toString(ints) + '}'; }
}
